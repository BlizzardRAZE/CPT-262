...
var ReservationUpdateForm = React.createClass({
  ...
  handleUpOptionChange: function (e) {
    this.setState({
      upReservationSelectedOptionTM: e.target.value,
    });
  },
  ...
  handleUpSubmit: function (e) {
    ...
    var updateReservationConfirmTM = this.state.upReservationSelectedOptionTM;
                ...
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      value="1"
                      checked={this.state.upReservationSelectedOptionTM === "1"}
                    ...
                    <input
                      ...
                      value="0"
                      checked={this.state.upReservationSelectedOptionTM === "0"}
                      onChange={this.handleUpOptionChange}
                      className="form-check-input"
                    />
                    No
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        var populateReservation = this.state.singleResDataTM.map(function (
          ...
          // console.log(reservation.dbreservationconfimed);
