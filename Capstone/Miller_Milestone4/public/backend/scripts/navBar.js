...
var ShowNavTM = React.createClass({
  ...
  render: function () {
    ...
    // Show Links if user is Employee
        ...
        <div className="navBarJS">
          ...
          <div className="dropdownContainer">
            ...
            <div className="dropdownItems">
              <a href="../search/searchuser.html">Search User</a>
            </div>
          </div>
          {/* Players */}
          <div className="dropdownContainer">
    ...
    // Show Links if user is Admin/Manager
    if (this.state.viewThePageTM == 1 || this.state.viewThePageTM == 2) {
      return (
        <div className="navBarJS">
          <div className="userNameContainer">
            {/* Show User's Name */}
