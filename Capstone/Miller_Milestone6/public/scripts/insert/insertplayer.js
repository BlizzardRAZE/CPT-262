      ...
      <form onSubmit={this.handleSubmit} className="formContainer">
        ...
        <table>
          <tbody>
            ...
            {/* Create Link to Sign In if Player does  have a account */}
            <tr>
                  <th>Have an Account Already?</th>
                  <td id="alignInput"><a href="../login.html">Login!</a></td>
                </tr>
          </tbody>
        </table>
        {/* Show Submit Button to Submit the form */}
        <input type="submit" value="Create Player" id="buttonSubmit" />
      </form>
    );
  },
});
