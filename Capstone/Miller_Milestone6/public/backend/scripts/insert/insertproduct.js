    ...
    if (
      ...
      return (
        ...
        <div className="mainContentBox">
          ...
          <ProductInsertForm onNewProductSubmit={this.handleProductSubmit} />
        </div>
      );
    }
  },
...
var ProductInsertForm = React.createClass({
  ...
  handleSubmit: function (e) {
    ...
    if (
      isNaN(productPriceTM) ||
      productPriceTM.length === 0 ||
      productPriceTM <= 0 ||
      productPriceTM > 9999.99
    ) {
      // Show Error to User
      window.alert(
    ...
    if (
      isNaN(productQuantityTM) ||
      productQuantityTM.length === 0 ||
      productQuantityTM <= 0 ||
      productQuantityTM > 99999
    ) {
      // Show Error to User
      window.alert(
